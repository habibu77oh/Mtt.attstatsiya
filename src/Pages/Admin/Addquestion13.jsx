...
function Addquestion13() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions13")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions13", JSON.stringify(updatedQuestions));
