...
function Addquestion11() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions11")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions11", JSON.stringify(updatedQuestions));
