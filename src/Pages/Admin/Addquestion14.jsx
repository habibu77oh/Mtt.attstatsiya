...
function Addquestion14() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions14")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions14", JSON.stringify(updatedQuestions));
