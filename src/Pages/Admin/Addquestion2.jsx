...
function Addquestion2() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions2")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions2", JSON.stringify(updatedQuestions));
    setQuestions(updatedQuestions); // savollar ro'yxatini yangilash
    setQuestion("");
    setOptions({ a: "", b: "", c: "", d: "" });
    setCorrectAnswer("");
