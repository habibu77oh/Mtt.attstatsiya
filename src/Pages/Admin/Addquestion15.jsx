...
function Addquestion15() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions15")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions15", JSON.stringify(updatedQuestions));
