...
function Addquestion12() {
  ...
  useEffect(() => {
    const storedQuestions =
      JSON.parse(localStorage.getItem("questions12")) || [];
  ...
  const handleAddQuestion = () => {
    ...
    localStorage.setItem("questions12", JSON.stringify(updatedQuestions));
